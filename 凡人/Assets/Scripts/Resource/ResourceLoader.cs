...
public class ResourceLoader
{
    ...
    public static UnityEngine.Object Load(string path, Type type)
    {
        ...
        {
            @object = null;
            //@object = LoadMachine.LoadObjImmediately(path, RES_TYPE.OBJECT);
            //if (@object == null)
            //{
            //    string text = path;
            //    text = EngineFun.RemoveExtensionName(text);
        ...
        else
        {
            ...
            if (@object == null)
            {
                ...
                if (type == typeof(GameObject))
                {
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text2, RES_TYPE.GAMEOBJECT);
                }
                if (type == typeof(MovieTexture))
                {
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text3, RES_TYPE.VIDEO);
                }
                if (type == typeof(Shader))
                {
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text4, RES_TYPE.SHADER);
                }
                if (type == typeof(Material))
                {
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text5, RES_TYPE.MATERIAL);
                }
                if (type == typeof(AudioClip))
                {
                    for (int i = 0; i < ResourcePath.DOT_AUDIOCIP.Length; i++)
                    {
                        string text6 = path;
                        if (!text6.Contains("_frres"))
                        {
                            text6 = text6 + ResourcePath.DOT_AUDIOCIP[i] + "_frres";
                        }
                        //@object = LoadMachine.LoadObjImmediately(text6, RES_TYPE.AUDIO);
                        if (@object != null)
                        {
                            break;
                        }
                ...
                {
                    for (int j = 0; j < ResourcePath.DOT_TEXTURE.Length; j++)
                    {
                        string text7 = path;
                        if (!text7.Contains("_frres"))
                        {
                            text7 = text7 + ResourcePath.DOT_TEXTURE[j] + "_frres";
                        }
                        //@object = LoadMachine.LoadObjImmediately(text7, RES_TYPE.TEXTURE);
                        if (@object != null)
                        {
                            break;
                        }
                ...
                if (type == typeof(TextAsset))
                {
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text8, RES_TYPE.TEXT);
                }
                if (type == typeof(Font))
                {
                    string text9 = path;
                    ...
                    //@object = LoadMachine.LoadObjImmediately(text9, RES_TYPE.FONT);
                }
                if (type == typeof(AnimationClip))
                {
                    string text10 = path;
                    if (!text10.Contains("_frres"))
                    {
                        text10 += ".anim_frres";
                    }
                    //@object = LoadMachine.LoadObjImmediately(text10, RES_TYPE.ANIM);
                }
                if (@object == null && type == typeof(UnityEngine.Object))
                {
                    //@object = LoadMachine.LoadObjImmediately(path, RES_TYPE.OBJECT);
                }
            }
