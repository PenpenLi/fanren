...
public class GameStateManager
{
    ...
    //			Dictionary<GameState, GameStateManager.void_fun> dictionary = initStateFuns = GameStateManager.InitStateFuns;
    //			GameStateManager.void_fun void_fun = initStateFuns[state];
    //			dictionary[state] = (GameStateManager.void_fun)Delegate.Remove(void_fun, fun);
    //			Dictionary<GameState, GameStateManager.void_fun> initStateFuns2;
    //			Dictionary<GameState, GameStateManager.void_fun> dictionary2 = initStateFuns2 = GameStateManager.InitStateFuns;
    //			void_fun = initStateFuns2[state];
    //			dictionary2[state] = (GameStateManager.void_fun)Delegate.Combine(void_fun, fun);
    //		}
    //	}
    ...
    //			Dictionary<GameState, GameStateManager.void_fun> dictionary = endStateFuns = GameStateManager.EndStateFuns;
    //			GameStateManager.void_fun void_fun = endStateFuns[state];
    //			dictionary[state] = (GameStateManager.void_fun)Delegate.Remove(void_fun, fun);
    //			Dictionary<GameState, GameStateManager.void_fun> endStateFuns2;
    //			Dictionary<GameState, GameStateManager.void_fun> dictionary2 = endStateFuns2 = GameStateManager.EndStateFuns;
    ...
    //		dictionary[state] = (GameStateManager.void_fun)Delegate.Remove(source, fun);
    //	}
